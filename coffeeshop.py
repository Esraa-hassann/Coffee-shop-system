...
root = Tk()
root.title("login ")
connection = sqlite3.connect('C:\\Users\\jana\\OneDrive\\Desktop\\cafemanagement.db', timeout=30)
...
def log():
    ...
    if username == 'reo' and password == '0000':
        ...
        def open_bill():
            ...
            def add():
                ...
                # //////
                cur.execute(
                    'INSERT INTO Customer_bill (customer_name,phone,item,quantity,Total_price) VALUES(?,?,?,?,?) ',
                    (name_c, ph, it, qua, total))
                conn.commit()
            ...
            btn_del = Button(frame2, text='DELETE', font=font, bg='#87c38f', fg='white', width=10, height=1,
                             command=clear)
        ...
        Button(frame, width=25, pady=10, text='products', fg='black', bg='#87c38f', border=0, command=open_pro).place(
            x=160, y=170)
        Button(frame, width=25, pady=10, text='category', fg='black', bg='#87c38f', border=0, command=open_cat).place(
            x=160, y=250)
        Button(frame, width=25, pady=10, text='customer bill', fg='black', bg='#87c38f', border=0,
               command=open_bill).place(x=160, y=330)
        screen.mainloop()
...
Button(frame, width=39, pady=7, text='login', fg='black', bg='#87c38f', border=0, cursor='hand2', command=log).place(
    x=35, y=277)
